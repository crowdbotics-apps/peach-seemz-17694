"""peach_seemz_17694 URL Configuration
...
admin.site.site_header = "Peach Seemz"
admin.site.site_title = "Peach Seemz Admin Portal"
admin.site.index_title = "Peach Seemz Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Peach Seemz API",
        default_version="v1",
        description="API documentation for Peach Seemz App",
    ),
    public=True,
